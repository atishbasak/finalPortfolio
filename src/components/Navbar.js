        ...
        <>
            <div className='navbar-box'>
                ...
                <div className='navbar-logo-mail'>
                    ...
                    <div className='hire-me-media blue-sq-filter'><Link to="/Contact">Hire Me !</Link></div>
                ...
                <div className={isOpen ? "navbar-hambarger-elements" : "navbar-elements"}>
                    <ul>
                        ...
                        <li className='blue-sq-filter'><Link to="/Blog" className='about about-ham'>Blog</Link></li>

                        {/* <div className='hire-me'>hire me !</div> */}
                        <div className='hire-me blue-sq-filter'><Link to="/Contact">hire me !</Link></div>
